...
| `DUMMY_IMAGE_FORMAT` | `JPEG` | Image format generated by the seed job. Use `GIF` for animated dummy data. |
| `DUMMY_GIF_FRAMES` | `6` | Number of frames per generated dummy GIF. |
| `DUMMY_GIF_FRAME_DELAY_MS` | `100` | Frame delay for generated dummy GIFs. |
